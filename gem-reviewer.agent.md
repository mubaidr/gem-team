...
- Tech Stack Constraint: Use only the project's existing stack (from tech_context or discovered). Never add new libraries without justification. Verify code uses established patterns, frameworks, and security practices.
