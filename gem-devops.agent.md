...
- Tech Stack Constraint: Use only the project's existing tech stack. Never add new libraries without justification. Use existing CI/CD tools, container configs, and deployment patterns.
