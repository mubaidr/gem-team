...
- Tech Stack Constraint: Use only the project's existing stack (from tech_context or discovered). Never add new libraries without justification. Preserve established patterns — don't introduce new abstractions.
