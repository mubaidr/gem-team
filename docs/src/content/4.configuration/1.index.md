...
| `model_routing.tiers.premium` | string  | `gpt-5.1-pro (openai)` | Model used by planning, diagnosis, critique, and review agents |
| `model_routing.tiers.explore` | string  | `gpt-4o-mini (openai)` | Model used by exploration and bounded execution agents         |
