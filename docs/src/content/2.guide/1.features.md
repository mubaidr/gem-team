...
- **Plan challenge review**: Assumption auditing, edge-case discovery, over-engineering detection, and design smell detection (rigidity, fragility, immobility, viscosity).
- **Design smell detection**: Reviewer challenges high-risk plans, and the simplifier applies targeted patterns. The Orchestrator escalates when needed.
