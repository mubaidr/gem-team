...
- **Library-first rule**: All agents prefer well-established, actively maintained libraries (official or already in the stack) over custom implementations. This constitutional rule runs across every phase - planning, implementation, review, and critique.
...
- **Design smell detection**: Planner checks material risks, critic challenges high-risk plans, and simplifier applies targeted patterns. The Orchestrator escalates when needed.
...
| Tier        | Best for                                                           |
| :---------- | :----------------------------------------------------------------- |
| **Premium** | Planning, debugging, critique, and review                          |
