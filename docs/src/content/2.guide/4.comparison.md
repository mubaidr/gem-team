...
| **Smarter context management**   | Plan-owned progressive context, three-tier memory, skill extraction        | Full history (bloat-prone) |
...
| **Resumable progress**           | Plan IDs, plan.yaml context, file-based artifacts                          | Stateless                  |
