...
| --------------------------------------- | -------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------- |
| **Default agents**                      | Fast / flash-class (e.g., `gpt-4o-mini`, `claude-3.5-haiku`, `gemini-2.5-flash`) | Routine implementation, documentation, research summaries, simple checks                  |
| **Planner, Debugger, Critic, Reviewer** | Strong / pro-class (e.g., `claude-4-20250514`, `gpt-5.1-pro`, `gemini-2.5-pro`)  | Planning, root-cause analysis, compliance checks, critical review, high-risk verification |

Replace these with equivalent models from your provider. This routing is configurable in `.gem-team.yaml`.

## Next Steps

- [Getting Started →](/getting-started/installation) — install and run Gem Team
- [Workflow →](/guide/workflow) — see how agents collaborate
