...
- Tech Stack Constraint: Use only the project's existing tech stack. Never add new libraries without justification. Check for version conflicts, incompatible dependencies, and stack-specific failure patterns.
